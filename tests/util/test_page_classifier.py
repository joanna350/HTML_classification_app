...
class DataSet():
    def __init__(self, html_str):
        self.list_of_text_strs = [html_str_to_one_string_of_visible_text(hstr) for hstr in [html_str]]
...
def test_PageClassifier():
    ...
    base = {'example_site_error.html': ([4], [0.099036, 0.12707462, 0.12858985, 0.08324735, 0.32321404, 0.23883814]),
            'example_product_landing.html': ([2],
                                           [0.04487083, 0.01430674, 0.73620608, 0.01140521, 0.14678729, 0.04642387]),
           'example_out_of_stock.html': ([3], [0.07218344, 0.0218594, 0.06108213, 0.6292346, 0.10222567, 0.11341476])
        }
    ...
    for fn in fns:
        ...
        pg.vectorizer = pickle_load(os.path.join('nate/saved_predictor_temp', 'vectorizer.pickle'))
